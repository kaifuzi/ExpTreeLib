...
#Region "       Private Fields"
    Private ReadOnly m_bytes() As Byte   'The local copy of the PIDL
    Private ReadOnly m_ItemCount As Integer      'the # of ItemIDs in this ItemIDList (PIDL)
...
#Region "       CPIDL enumerator Class"
    Private Class ICPidlEnumerator
        ...
        Private ReadOnly m_bytes() As Byte   'the local copy of the PIDL
        Private ReadOnly m_NotEmpty As Boolean = False 'the desktop PIDL is zero length
