...
#Region "   Shared Private Fields"
    ...
    Private Shared ReadOnly DriveDict As New Dictionary(Of String, Boolean)   '4/16/2012
...
#Region "       Normal Properties"
    ...
    Public ReadOnly Property ItemPath() As String
        Get
            ...
            Dim pathlist As New List(Of CShItem) From {
                item
            }  'pathlist.Add(item)
                ...
                Else            'new parent of this item IS in internal tree, fix up and update any files/folders of THIS item
                    If (ShellAPI.SHGetRealIDL(newParentItem.Folder, newPidlRel, PidlRel) = S_OK) Then
                        ...
                        If IsFolder Then            'deal with potential "Move" to a new dir
                            If newParentItem IsNot Me.Parent Then
                            ...
                            End If
                        Else
                            If oldParentItem IsNot newParentItem Then
...
Public Class ShellItemUpdateEventArgs
    Inherits EventArgs
    Private ReadOnly m_Item As CShItem
    Private ReadOnly m_Type As CShItem.CShItemUpdateType
