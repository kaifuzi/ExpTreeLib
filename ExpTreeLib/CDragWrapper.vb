...
Public Class CDragWrapper
    ...
    Private ReadOnly m_Client As Control
    ...
    Private ReadOnly isTreeView As Boolean
    ...
    Sub ItemDrag(ByVal sender As Object, ByVal e As ItemDragEventArgs)
        ...
        Else        'ListView may have more than one item to drag
            ...
            For i = 0 To ctl.SelectedItems.Count - 1
                If parent IsNot DirectCast(ctl.SelectedItems(i).Tag, CShItem).Parent Then Exit Sub
...
Public Class DragStartEventArgs
    Inherits EventArgs
    Private ReadOnly m_parent As CShItem
    Private ReadOnly m_DragStartControl As Control
