...
Public Class WindowsContextMenu
    ...
    Private ReadOnly min As Integer = 1
    Private ReadOnly max As Integer = 100000
...
FAIL:
    ...
    Public Sub InvokeCommand(ByVal iContextMenu As IContextMenu, ByVal cmd As UInteger, ByVal parentDir As String, ByVal ptInvoke As System.Drawing.Point)
        Dim invoke As ShellAPI.CMInvokeCommandInfoEx = New ShellAPI.CMInvokeCommandInfoEx With {
            .cbSize = ShellAPI.cbInvokeCommand,
            .lpVerb = CType(cmd, IntPtr),
            .lpDirectory = parentDir,
            .lpVerbW = CType(cmd, IntPtr),
            .lpDirectoryW = parentDir,
            .fMask = ShellAPI.CMIC.UNICODE Or ShellAPI.CMIC.PTINVOKE
        }
